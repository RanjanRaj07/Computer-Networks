...
#bandwidth settings
$ns bandwidth $bs1 $ms 384000 simplex
$ns bandwidth $ms $bs1 64000 simplex
$ns bandwidth $bs2 $ms 384000 simplex
$ns bandwidth $ms $bs2 64000 simplex
#delay
$ns delay $bs1 $ms .150 simplex
$ns delay $ms $bs1 .150 simplex
$ns delay $bs2 $ms .150 simplex
$ns delay $ms $bs2 .150 simplex
#queue-limit
$ns queue-limit $bs1 $ms 20
$ns queue-limit $ms $bs1 20
$ns queue-limit $bs2 $ms 20
$ns queue-limit $ms $bs2 20
#insert-delayer
